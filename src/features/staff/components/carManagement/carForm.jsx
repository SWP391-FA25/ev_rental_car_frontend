...
export default function CarForm({
  ...
  const VEHICLE_STATUS = [
    ...
    {
      value: 'MAINTENANCE',
      label: t('vehicle.status.maintenance') || 'Maintenance',
    },
    {
      value: 'OUT_OF_SERVICE',
      label: t('vehicle.status.outOfService') || 'Out of Service',
    },
  ];
  ...
  const validationSchema = Yup.object({
    ...
    year: Yup.number()
      ...
      .max(
        ...
        t('vehicle.validation.invalidYear') ||
    ...
    onSubmit: async (values, { setSubmitting, resetForm }) => {
      try {
        ...
        if (success) {
          ...
          toast.success(
            t('vehicle.messages.createSuccess') || 'Vehicle created'
          );
          ...
          const errors =
            response?.data?.errors ?? response?.data?.validationErrors ?? null;
          if (errors && typeof errors === 'object') {
            setServerErrors(errors);
          } else {
            setServerErrors({
              _form: response?.data?.message || 'Create failed',
            });
          }
        }
      } catch (err) {
  ...
  const renderError = field =>
    (formik.touched[field] && formik.errors[field]) || serverErrors[field] ? (
      <p className='text-red-500 text-sm mt-1'>
        {formik.errors[field] || serverErrors[field]}
      </p>
    ) : null;
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div className='space-y-2'>
              ...
              <Input
                ...
                className={
                  formik.errors.batteryLevel && formik.touched.batteryLevel
                    ? 'border-red-500'
                    : ''
                }
              />
            ...
            <div className='space-y-2'>
              ...
              >
                <SelectTrigger
                  className={
                    formik.errors.stationId && formik.touched.stationId
                      ? 'border-red-500'
                      : ''
                  }
                >
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div className='space-y-2'>
              ...
              <Input
                ...
                placeholder='200.00'
                className={
                  formik.errors.baseRate && formik.touched.baseRate
                    ? 'border-red-500'
                    : ''
                }
              />
            ...
            <div className='space-y-2'>
              ...
              <Input
                ...
                placeholder='1200.00'
                className={
                  formik.errors.weeklyRate && formik.touched.weeklyRate
                    ? 'border-red-500'
                    : ''
                }
              />
            ...
            <div className='space-y-2'>
              ...
              <Input
                ...
                placeholder='4500.00'
                className={
                  formik.errors.monthlyRate && formik.touched.monthlyRate
                    ? 'border-red-500'
                    : ''
                }
              />
            ...
            <div className='space-y-2'>
              ...
              <Input
                ...
                placeholder='0.10 (10%)'
                className={
                  formik.errors.insuranceRate && formik.touched.insuranceRate
                    ? 'border-red-500'
                    : ''
                }
              />
        ...
        <div className='space-y-4'>
            ...
            {tempImages.length > 0 ? (
              ...
              <div className='col-span-full text-center text-muted-foreground py-8 border-2 border-dashed rounded-lg'>
                ...
                <p className='text-xs mt-1'>
                  Click "Select Images" to add photos (max 5MB each)
                </p>
              </div>
            )}
          </div>
          ...
          {tempImages.length > 0 && (
            <p className='text-sm text-muted-foreground'>
              {tempImages.length} image(s) will be uploaded after vehicle
              creation
            </p>
          )}
        </div>
      ...
      <div className='flex flex-col sm:flex-row justify-end gap-2 pt-4'>
        ...
        <Button
          type='submit'
          disabled={loading || formik.isSubmitting || imageLoading}
          className='w-full sm:w-auto'
        >
          {formik.isSubmitting
